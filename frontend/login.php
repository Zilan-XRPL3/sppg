...
<head>
    ...
    <style>
        ...
        .circle {
            ...
            z-index: -1;
            border-radius: 50%;
            background: linear-gradient(135deg, #E2EAD3 0%, #D4DFC7 100%);
            filter: blur(50px);
        }
        ...
        .login-card { 
            ...
            padding: 50px 40px; 
            border-radius: 40px; 
            box-shadow: 0 25px 50px rgba(45, 58, 21, 0.08); 
            width: 100%;
            max-width: 380px; 
            text-align: center; 
        ...
        .icon-box {
            ...
            margin: 0 auto 25px;
            font-size: 28px;
            box-shadow: 0 10px 20px rgba(45, 58, 21, 0.2);
        }
        ...
        button:hover { 
            ...
            box-shadow: 0 10px 20px rgba(139, 168, 76, 0.3);
        }
